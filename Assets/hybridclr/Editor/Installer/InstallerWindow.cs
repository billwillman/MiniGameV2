...
namespace HybridCLR.Editor.Installer
{
    public class InstallerWindow : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            {
                Debug.LogError($"[HybridCLR Installer] init failed: {e}");
            }
        }
        ...
        private void OnGUI()
        {
            ...
            if (_controller == null)
            {
                EditorGUILayout.HelpBox("Installer init failed. HybridCLR package.json was not found under Packages/com.code-philosophy.hybridclr or Assets/hybridclr.", MessageType.Error);
